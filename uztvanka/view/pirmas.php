...
<?php foreach ($bebrai as $bebras): ?>
  <li class="list-group-item uztvanka">
    ...
    <form class="m-2" action="<?= URL ?>delete/<?= $bebras['id'] ?>" method="post">
  ...
  <form class="m-2" action="<?= URL ?>add-black/<?= $bebras['id'] ?>" method="post">
    <div class="form-bebrai">
      <label>Prideti juodus: </label><input type="text" name="count">
  ...
  <form class="m-2" action="<?= URL ?>add-brown/<?= $bebras['id'] ?>" method="post">
    <div class="form-bebrai">
      <label>Prideti rudus: </label><input type="text" name="count">
      <button type="submit" class="btn btn-info">+</button>
    </div>
  </form>
  <form class="m-2" action="<?= URL ?>rem-brown/<?= $bebras['id'] ?>" method="post">
    <div class="form-bebrai">
